...
function alCargar(){
	...
	if (idioma==2) {
		document.getElementsByTagName("header")[0].innerHTML="<span><p>ALICIA</span>'S CALCULATOR</p>";
		...
		document.getElementsByTagName("header")[0].innerHTML="<p>CALCULADORA D'<span>ALÃCIA</span></p>";
		document.getElementById("tpan").innerHTML="Veure<br>Pantalla";
		document.getElementById("trai").innerHTML="AR";
		textoDivision1="<p class='perror'>El dividend Ã©s zero, per tant el resultat Ã©s zero.</p>";
		textoDivision2="<p class='perror'>El divisor Ã©s zero, per tant no existeix soluciÃ³ per aquesta divisiÃ³.</p>";
		textoDivision3="<p class='perror'>El dividend i el divisor sÃ³n zero, per tant no existeix soluciÃ³ per aquesta divisiÃ³.</p>";
		textoMultiplicacion1="<p class='perror'>EstÃ s multiplicant por zero, per tant el resultat Ã©s zero.</p>";
		textoMultiplicacion2="<p class='perror'>El resultat obtingut Ã©s massa gran.</p>";
		textoRaiz1="<p class='perror'>L'arrel quadrada de zero Ã©s zero.</p>";
		textoDFactorial1="<p class='perror'>No tÃ© sentit fer la descomposiciÃ³ factorial de zero.</p>";
	}
	else {
		document.getElementsByTagName("header")[0].innerHTML="<p>CALCULADORA DE <span>ALICIA</span></p>";
		...
		textoDivision2="<p class='perror'>El divisor es cero, por lo tanto no existe soluciÃ³n a la divisiÃ³n propuesta.</p>";
		textoDivision3="<p class='perror'>El dividendo y el divisor son cero, por lo tanto no existe soluciÃ³n a la divisiÃ³n propuesta.</p>";
		textoMultiplicacion1="<p class='perror'>EstÃ¡s multiplicando por cero, por lo tanto el resultado es cero.</p>";
		textoMultiplicacion2="<p class='perror'>El resultado obtenido es demasiado grande.</p>";
		textoRaiz1="<p class='perror'>La raÃ­z cuadrada de cero es cero.</p>";
		textoDFactorial1="<p class='perror'>No tiene sentido hacer la descomposiciÃ³n factorial de cero.</p>";
	}
